  ...
  <div class="slide-container swiper">
    <div class="slide-content">
      ...
      <div class="card swiper-slide">
          ...
          <div class="card-content">
            <h2 class="name">Soham Patel</h2>
            <p class="description">Enrollment No. : 200280107028</p>
        ...
        <div class="card swiper-slide">
          <div class="image-content">
            ...
            <div class="card-image">
              <img src="images/sohamd.jpg" alt="" class="card-img">
            </div>
          </div>

          <div class="card-content">
            <h2 class="name">Soham D. Patel</h2>
